...
public class ProductRegisterController {  // TODO: 필터체인에 /admin으로 접근시 ROlE이 ADMIN인지 확인 넣기
    ...
    @PostMapping("/{productRegisterId}/approve")
    ...
    @PostMapping("/{productRegisterId}/reject")
    ...
    @PostMapping("/{productRegisterId}/hold")
    ...
    public ApiResponse<Page<ProductRegistersResponse>> getProductsRegisters(
        ...
        Page<ProductRegistersResponse> responses = productRegisterQueryService.getProductsRegisters(pageable, status);
